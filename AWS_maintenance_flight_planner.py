...
if campaign=="Swiss_Camp_2021_July_23-30":
    ...
    time,fly_time,fuel_use,fuel_remaining=inter_dist(fuel_remaining,fuel_use,work,date,start_time,day_counter,"JAV","SWC",time,0.5,cargo_mass,4,fly_time)
    work="return empty to JAV"
    time,fly_time,fuel_use,fuel_remaining=inter_dist(fuel_remaining,fuel_use,work,date,start_time,day_counter,"SWC","JAV",time,0.5,0,4,fly_time)
    out_concept.write(",,,,,,,,total fly time no taxi or circling,{:.1f}".format(fly_time)+"\n")
    ...
    N_PAX=2
    time,fly_time,fuel_use,fuel_remaining=inter_dist(fuel_remaining,fuel_use,work,date,start_time,day_counter,"JAV","SWC",time,0.5,200,N_PAX,fly_time)
    time,fly_time,fuel_use,fuel_remaining=inter_dist(fuel_remaining,fuel_use,work,date,start_time,day_counter,"SWC","JAV",time,0.5,200,0,fly_time)
    out_concept.write(",,,,,,,,total fly time no taxi or circling,{:.1f}".format(fly_time)+"\n")
    day_counter+=1 ; date+=datetime.timedelta(days=1)
    ...
    N_PAX=5
    time,fly_time,fuel_use,fuel_remaining=inter_dist(fuel_remaining,fuel_use,work,date,start_time,day_counter,"JAV","SWC",time,1.5,100,N_PAX,fly_time)
    time,fly_time,fuel_use,fuel_remaining=inter_dist(fuel_remaining,fuel_use,work,date,start_time,day_counter,"SWC","JAV",time,0.5,200,0,fly_time)
    out_concept.write(",,,,,,,,total fly time no taxi or circling,{:.1f}".format(fly_time)+"\n")
    day_counter+=1 ; date+=datetime.timedelta(days=1)
    ...
    work="Pull all out"
    time,fly_time,fuel_use,fuel_remaining=inter_dist(fuel_remaining,fuel_use,work,date,start_time,day_counter,"JAV","SWC",time,0.5,0,0,fly_time)
    time,fly_time,fuel_use,fuel_remaining=inter_dist(fuel_remaining,fuel_use,work,date,start_time,day_counter,"SWC","JAV",time,0.5,100,5,fly_time)
    ...
    time,fly_time,fuel_use,fuel_remaining=inter_dist(fuel_remaining,fuel_use,work,date,start_time,day_counter,"JAV","SWC",time,0.5,0,0,fly_time)
    time,fly_time,fuel_use,fuel_remaining=inter_dist(fuel_remaining,fuel_use,work,date,start_time,day_counter,"SWC","JAV",time,0.5,100,2,fly_time)
    out_concept.write(",,,,,,,,total fly time no taxi or circling,{:.1f}".format(fly_time)+"\n")
