...
#%%
fn='/Users/jason/Dropbox/AWS/GCN_PROMICE_kml/input_data/PROMICE_info_from_GPS_data_2017-2018.csv'
# fn='/Users/jason/Dropbox/Stober/Swiss Camp positions and SMB 1991-2014 from M Stober 4.csv'

df = pd.read_csv(fn,sep='\t')

n_sites=len(df.name)
opath='/Users/jason/Dropbox/AWS/GCN_PROMICE_kml/kml/PROMICE/'
